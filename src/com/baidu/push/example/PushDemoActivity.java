...
import com.yuri.push.BaiduPushUtil;
...
public class PushDemoActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("manual:" + Build.MANUFACTURER);
    ...
    private void initWithApiKey() {
    	Log.d(TAG, "initWithApiKey.PushManager.startWork");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	...
    	getMenuInflater().inflate(com.yuri.baidu.push.demo.R.menu.main, menu);
    	return super.onCreateOptionsMenu(menu);
    }
    
    private static final String URL = "http://channel.api.duapp.com/rest/2.0/channel/channel";
    private static final String HUAWEI_USERID = "755907526971029342";
    private static final String HUAWEI_CHANNELID = "3795280686575106357";
    
    private static final String SAMSUNG_USERID = "588461006475427177";
    private static final String SAMSUNG_CHANNELID = "4478174490640659091";
    
    private static final String E550WD_USERID = "819928879561433662";
    private static final String E550WD_CHANNELID = "4295700755807316267";
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
    	// TODO Auto-generated method stub
    	switch (item.getItemId()) {
		case R.id.menu_send_to_huawei:
			new Thread(new Runnable() {
				@Override
				public void run() {
					String respondStr = new BaiduPushUtil().push_msg(
							HUAWEI_USERID, HUAWEI_CHANNELID, "Are You Huawei?", "Please ansewer if you are huawei.");
					Log.d(TAG, "SendToHUAEWI:" + respondStr);
				}
			}).start();
			
			break;
		case R.id.menu_send_to_samsung:
			new Thread(new Runnable() {
				@Override
				public void run() {
					String respondStr = new BaiduPushUtil().push_msg(
							SAMSUNG_USERID, SAMSUNG_CHANNELID, "Are You Samsung?", "Please ansewer if you are Samsung.");
					Log.d(TAG, "SENDTOSUMSANG:" + respondStr);
				}
			}).start();
			break;
		case R.id.menu_send_to_all:
			new Thread(new Runnable() {
				@Override
				public void run() {
					String respondStr = new BaiduPushUtil().push_msgToAll("Send To Everyone", "Send To Everyone");
					Log.d(TAG, "SENDTOALL:" + respondStr);
				}
			}).start();
			break;
